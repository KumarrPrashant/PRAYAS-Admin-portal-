...
export function IssueDetails({ issueId }: IssueDetailsProps) {
  ...
  return (
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center space-x-2">
            <Badge className={statusColors[currentStatus as keyof typeof statusColors]}>{currentStatus}</Badge>
      ...
      <StatusManagement issueId={issue.id} currentStatus={currentStatus} onStatusChange={handleStatusChange} />
    </div>
  )
}
